...
{/* item 3 */}
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-purple-600 mb-2">Kurumsal Değerler</div>
                  <p className="text-xl text-gray-400 mb-4">Topluma çevresel ve ekonomik fayda sağlayıp, paylaşımcılığımızla farkındalık yaratırız.
                  <br/> 
                  <br/> 
                  
                  Araştıran, takip eden ve gelişen bir kurum kültürü ile tüm paydaşlarımızın beklentilerini anlayarak hizmetlerimizi sürekli geliştirmeye çabalırız
                  <br/>
                  <br/>

                  Paydaşlarımızın ihtiyaçlarını göz ederek memnuniyetlerini her zaman beklentilerinin üzerinde tutmayı hedefleriz.
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Topluma Katkı Sağlamak</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                    ...
                    <li className="flex items-center">
                      ...
                      <span>Paydaşların Mutluluğu</span>
                    </li>
                  </ul>
                </div>
              </div>
